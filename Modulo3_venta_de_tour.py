...
#En cada funcion correspondiente a los distintos tours se validan las entradas del usuario y al final se realiza una factura dando el resumen de la compra del cliente.
#funcion para el tour por el puerto
...
#funcion para el tour gastronomico
def food_tour():
    while True:
...
#funcion para el tour de trotar en la ciudad con sus validaciones
def runner_tour():
    while True:
...
#funcion destinada al tour de sitios turisticos
def historic_tour():
...
#funcion donde se le muestra al usuario los disintos dtipos de tour disponibles
...
#se inicia el codigo con la funcion main y se le pregunta al usuario que desea hacer con sus respectivas validaciones
