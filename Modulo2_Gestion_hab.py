...
#funcion que sirve como formulario
...
def form(count):
 ...
 #Luego de que pasa el registro del cliente se le da un resumen de su compra
 #la seccion de la factura en donde se agregan las habitaciones a la facura esta en blanco (falta de tiempo para la entrega) ##TODO##
...
#funcion main para inizializar el modulo y asi ejecutar las funciones segun se necesiten
def main():
    print((msgb).title(),"\n")
